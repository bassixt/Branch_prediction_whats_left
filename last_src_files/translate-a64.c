...
static void disas_uncond_b_imm(DisasContext *s, uint32_t insn)
{
	...
	TCGv_i64 tcg_pc1, tcg_addr1, tcg_t_nt1;//to be passed to our function
    tcg_pc1 = tcg_const_i64(s->pc);//create a variable of type tcg_pc1 containing actual pc
    tcg_addr1 = tcg_const_i64(addr);
    tcg_t_nt1 = tcg_const_i64(1);
    gen_helper_printer(tcg_pc1,tcg_addr1,tcg_t_nt1);//call our function
    tcg_temp_free_i64(tcg_pc1);//free the temporary values
